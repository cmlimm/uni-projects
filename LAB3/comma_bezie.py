...
bezie((width*8//16, height*2//16), (width*4//16, height*2//16), (width*4//16, height*10//16), (width*9//16, height*7//16))
bezie((width*8//16, height*2//16), (width*12//16, height*2//16), (width*11//16, height*10//16), (width*7//16, height*12//16))
bezie((width*9//16, height*7//16), (width*9//16, height*7//16), (width*9//16, height*9//16), (width*7//16, height*12//16))
image.show()
image.save("comma_bezie.jpg")
del draw
