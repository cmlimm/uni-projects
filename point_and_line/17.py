...
point1 = Point(0, 0)
print(line1.rotatedLine(point1))

line2 = Line.fromCoord(1, 0, 0, 1)
point2 = Point(2, 2)
print(line2.rotatedLine(point2))

line3 = Line.fromCoord(-10.68, 12.53, -11.92, -0.95)
point3 = Point(6.38, 1.82)
print(line3.rotatedLine(point3))
