...
line(width//2,height-1,0,height//2, draw)

line(width//2,height-1,0,0, draw)
line(width//2,0,width-1,height-1, draw)
line(width-1,0,width//2,height-1, draw)
line(width//2,0,0,height-1, draw)
image.show()
