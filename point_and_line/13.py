...
point1 = Point(2, 2)
point2 = Point(1, 3)
print(line1.projectionLength(point1, point2))

line2 = Line.fromCoord(-1.21, 6.22, -6.47, 13.09)
point3 = Point(3.16, -7.26)
point4 = Point(12.80, -10.56)
print(line2.projectionLength(point3, point4))
